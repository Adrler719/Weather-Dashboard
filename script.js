$(document).ready(function () {
    ...
    function weatherFunction(searchTerm) {
      ...
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/weather?q=" + searchTerm + "&appid=376cd8637f060a4ee558b77f0575fab8",
        ...
        $.ajax({
          type: "GET",
          url: "https://api.openweathermap.org/data/2.5/uvi?appid=376cd8637f060a4ee558b77f0575fab8&lat=" + lat + "&lon=" + lon,
    ...
    // function to display weather forecast info for city searched
    function weatherForecast(searchTerm) {
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/forecast?q=" + searchTerm + "&appid=376cd8637f060a4ee558b77f0575fab8&units=imperial",
